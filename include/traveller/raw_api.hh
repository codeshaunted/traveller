...
namespace traveller {
namespace raw_api { // TODO: maybe move these to be static class members, rather than just globals in a namespace?
...
#define TRAVELLER_REGISTER_RAW_API_GLOBAL(Address, Type, Name) Type* Name = (Type*)Address
